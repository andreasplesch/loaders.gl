...
export default class App extends PureComponent {
    ...
    _renderControlPanel() {
        ...
        return (_jsx(ControlPanel, { data: examplesByCategory, category: category, name: name, tileset: tileset, onMapStyleChange: this._onSelectMapStyle.bind(this), onExampleChange: this._onSelectExample.bind(this), selectedMapStyle: selectedMapStyle, children: _jsxs("div", { style: { textAlign: 'center' }, children: ["long/lat: ", viewState.longitude.toFixed(5), ",", viewState.latitude.toFixed(5), ", zoom:", ' ', viewState.zoom.toFixed(2)] }) }));
    }
    _renderStats() {
        // TODO - too verbose, get more default styling from stats widget?
        return (_jsx(StatsWidgetContainer, { ref: (_) => (this._statsWidgetContainer = _) }));
    }
    _renderTile3DLayer() {
    ...
    render() {
        ...
        return (_jsxs("div", { style: { position: 'relative', height: '100%' }, children: [this._renderStats(), this._renderControlPanel(), _jsx(DeckGL, { layers: [tile3DLayer], viewState: viewState, onViewStateChange: this._onViewStateChange.bind(this), controller: { type: MapController, maxPitch: 85, inertia: true }, onAfterRender: () => this._updateStatWidgets(), children: _jsx(Map, { reuseMaps: true, mapLib: maplibregl, mapStyle: selectedMapStyle, preventStyleDiffing: true }) })] }));
    }
}
